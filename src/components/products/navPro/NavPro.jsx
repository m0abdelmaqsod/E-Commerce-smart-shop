      ...
      <div className={styles.navPro}>
        ...
        <div className={styles.filter_number}>
          <div className={styles.div_filNum}>
            ...
            <button
              onClick={() => setWatchPro(30)}
              className={watchPro == 30 ? styles.active : ""}
            >
              30
            </button>
            <button
              onClick={() => setWatchPro(24)}
              className={watchPro == 24 ? styles.active : ""}
            >
              24
            </button>
            <button
              onClick={() => setWatchPro(18)}
              className={watchPro == 18 ? styles.active : ""}
            >
              18
            </button>
            <button
              onClick={() => setWatchPro(12)}
              className={watchPro == 12 ? styles.active : ""}
            >
              12
            </button>
            <button
              onClick={() => setWatchPro(9)}
              className={watchPro == 9 ? styles.active : ""}
            >
              9
            </button>
        ...
        <div className={styles.filter_all_div}>
          <button
            onClick={handlerActiveSmall}
            className={
              isActive == true ? styles.icon_filBig : styles.btnActiveIcon
            }
          >
            <span></span>
            <span></span>
          ...
          <button
            onClick={handlerActiveBig}
            className={
              isActive == false ? styles.icon_filSmall : styles.btnActiveIcon
            }
          >
            <HiOutlineSquares2X2 />
          </button>
